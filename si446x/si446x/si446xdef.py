...
- radio_config_group_ids = (enum) convert group name to identifier
- radio_config_groups    = (dict) identifier : group structure
- radio_config_cmd_ids   = (enum) convert command name to identifer
- radio_config_commands  = (dict) identifier : (cmd structure,
                                                rsp structure)
...
def _display_fast_frr(str, buf):
    ...
    s = ''
    s += 'state: {}'.format(rsp.state)
    s += _display_items('ph_pend', rsp.ph_pend.items)
    s += _display_items('modem_pend', rsp.modem_pend.items)
    s += ', rssi: {}'.format(rsp.rssi)
    return s
...
#                       Field('bcr_nco_offset',3),
                       ...
                       Byte('rssi_comp'),
                       Padding(1),
                       BitStruct('raw_search2',
                                 Enum(BitField('sch_frzen',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('rawflt_sel',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('schprd_hi',3),
                                      SEARCH_2TB   = 0,
                                      SEARCH_3TB   = 1,
                                      SEARCH_4TB   = 2,
                                      SEARCH_5TB   = 3,
                       ...
                       BitStruct('clkgen_band',
                                 Padding(3),
                                 Enum(BitField('force_sy_recal',1),
                                      FORCE     = 0,
                                      SKIP      = 1,
                                 ),
                                 Enum(BitField('sy_en',1),
                                      ENUM_0     = 0,
                                      ENUM_1     = 1,
                                 ),
                                 Enum(BitField('band',3),
                                      FVCO_DIV_4  = 0,
                                      FVCO_DIV_6  = 1,
                                      FVCO_DIV_8  = 2,
                                      FVCO_DIV_16 = 4,
                       ...
                       Padding(2),
                       BitStruct('spike_detect',
                                 Enum(BitField('spike_removal_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('spike_threshold',7),
                       ),
                       BitStruct('one_shot_afc',
                                 Enum(BitField('oneshot_afc_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('bcr_align_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('est_osr_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('afcma_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('oneshot_wait_cnt',4),
                       ),
                       Byte('rssi_hysteresis'),
                       BitStruct('rssi_mute',
                                 Padding(4),
                                 Enum(BitField('rssi_delay',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('rssi_delay_cnt',3),
                       ),
                       BitStruct('fast_rssi_delay',
                                 BitField('delay',8),
                       ),
                       BitStruct('psm',
                                 Padding(4),
                                 BitField('idle_time', 12),
                       ),
                       BitStruct('dsa_ctrl1',
                                 Enum(BitField('qual_source',2),
                                      SPIKE_QUAL     = 0,
                                      SPIKE_EYE_QUAL = 1,
                                 ),
                                 Enum(BitField('dsa_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('adj_samp_err_tolerance',5),
                       ),
                       BitStruct('dsa_ctrl2',
                                 Padding(1),
                                 Enum(BitField('sync_qual',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('bcr_gear_shift',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Padding(1),
                                 BitField('arrival_thd',4),
                       ),
                       BitStruct('dsa_qual',
                                 Enum(BitField('eye_qual_sel',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('arrqual',7),
                       ...
                       BitStruct('dsa_rssi',
                                 Enum(BitField('squelch_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 BitField('dsa_rssi_threshold',7),
                       ),
                       BitStruct('dsa_misc',
                                 Enum(BitField('cc_assess_sel',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('eyexext_en',1),
                                      DISABLE     = 0,
                                      ENABLE      = 1,
                                 ),
                                 Enum(BitField('eyexest_fast',1),
                                      WINDOW4     = 0,
                                      WINDOW8     = 1,
                                 ),
                                 Padding(2),
...
pa_group_s = Struct('pa_group_s',
                    ...
                    BitStruct('dig_pwr_seq_config',
                              Enum(BitField('inc_step_size',1),
                                   STEP_SIZE_1   = 0,
                                   STEP_SIZE_2   = 1,
                              ),
                              BitField('dig_pwr_seq_delay',7),
                    ),
)
...
radio_status_cmd_ids = Si446xStatusCmds_t(Byte('radio_status_cmd_ids'))
...
radio_status_commands = {
    radio_config_cmd_ids.build('PART_INFO'): (_status_part_info, read_part_info_rsp_s),
    radio_config_cmd_ids.build('FUNC_INFO'): (_status_default, read_func_info_rsp_s),
    radio_config_cmd_ids.build('GPIO_PIN_CFG'): (_status_default, get_gpio_pin_cfg_rsp_s),
    radio_config_cmd_ids.build('FIFO_INFO'): (_status_default, fifo_info_rsp_s),
    radio_config_cmd_ids.build('GET_INT_STATUS'): (_status_ints, int_status_rsp_s),
    ...
    radio_config_cmd_ids.build('PACKET_INFO'): (_status_default, packet_info_rsp_s),
    ...
    radio_config_cmd_ids.build('GET_CHIP_STATUS'): (_status_default, get_chip_status_rsp_s),
}
...
def insert_space(st):
    ...
    while (i < (len(st) * 2)):
        ins_ch = '' if ins_ch is '.' else '.'
        p_ds += p_s[i:i+ix] + ins_ch
        i += ix
    return p_ds
